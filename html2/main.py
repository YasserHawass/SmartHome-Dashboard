...
white_button_style = {'display':'flex'}

red_button_style = {'display':'none'}
...
app.layout = html.Div([
    html.Div([
        ...
        html.Button("Home/Dashboard", id="m_button", n_clicks=0, style=white_button_style),
    ...
    ], id = "mainboard",className="mainboard", style=white_button_style),

    html.Div([
        html.H1("Dashboard"),
    ], id = "dashboard", style=red_button_style)
...
def update_m_button(n_clicks):
    if n_clicks % 2 == 0:
        ...
        return red_button_style, white_button_style
